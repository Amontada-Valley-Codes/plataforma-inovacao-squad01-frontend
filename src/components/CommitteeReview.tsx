...
export function CommitteeReview({ user }: CommitteeReviewProps) {
	...
	const handleDecision = async (
		...
		try {
			...
			alert(
				`Ideia ${decision === "approve" ? "aprovada" : "rejeitada"
				} com sucesso!`
			);
			fetchAndProcessData();
		} catch (error) {
				...
				<main className="flex-1 overflow-y-auto">
					<div className="container mx-auto px-6 py-8">
						...
						>
							...
							>
								<CardTitle
									className={`text-xl ${theme === "dark" ? "text-gray-200" : "text-gray-800"
										}`}
								>
										...
										<AccordionItem key={idea.id} value={idea.id}>
											...
											>
												<div className="text-left">
													<p
														className={`font-semibold text-base text-[#001f61] ${theme === "dark"
															? "text-gray-200"
															: "text-gray-800"
															}`}
													>
													...
													<div className="space-y-4">
														...
														<div className="space-y-4 max-h-48 overflow-y-auto pr-2">
															{idea.discussionComments.length > 0 ? (
																...
																<p
																	className={`text-sm text-center py-4 ${theme === "dark"
																		? "text-gray-400"
																		: "text-gray-500"
																		}`}
																>
														...
														<div className="flex items-start gap-3 pt-4 border-t border-gray-200">
															...
															<div className="w-full space-y-2">
																<Textarea
																	...
																	className={`focus:border-[#001f61] focus:ring focus:ring-[#001f61]/30 transition-colors ${theme === "dark"
