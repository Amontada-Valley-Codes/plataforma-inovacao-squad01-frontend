		...
		>
						...
						<CardContent>
							<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
								<div className="text-center">
									<div
										className={`text-2xl font-bold ${theme === "dark" ? "text-gray-400" : "text-gray-800"
											}`}
									>
										{submissions.length}
									</div>
									<p
										className={`text-sm ${theme === "dark" ? "text-gray-200" : "text-gray-500"
											}`}
									>
										Ideias Submetidas
									</p>
								...
								<div className="text-center">
									<div
										className={`text-2xl font-bold ${theme === "dark" ? "text-gray-400" : "text-green-600"
											}`}
									>
										4
									</div>
								...
								<div className="text-center">
									<div
										className={`text-2xl font-bold ${theme === "dark" ? "text-gray-400" : "text-blue-600"
											}`}
									>
										2
									</div>
								...
								<div className="text-center">
									<div
										className={`text-2xl font-bold ${theme === "dark" ? "text-gray-400" : "text-yellow-600"
											}`}
									>
										87%
									</div>
			...
			<div className="container pb-7 mx-auto px-4 sm:px-6 mt-8">
				<Tabs defaultValue="submissions">
					...
					<TabsList
						className={`w-full overflow-x-auto overflow-y-hidden justify-start border-b ${theme === "dark"
								? "bg-gray-800 border-gray-700"
								: "bg-white border-gray-200"
							}`}
					>
						<TabsTrigger
							className={`py-3 px-3 sm:py-4 cursor-pointer sm:px-6 text-sm font-medium whitespace-nowrap ${theme === "dark"
					...
					<TabsContent value="startups">
						<Card
							className={`bg-white mt-4 ${theme === "dark" ? "bg-gray-800 text-white" : ""
								}`}
						>
							<CardHeader>
									...
									>
										<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4">
											<div className="space-y-2 mb-2 sm:mb-0">
												...
												<div
													className={`flex flex-wrap gap-x-4 text-xs ${theme === "dark" ? "text-gray-400" : "text-gray-500"
														}`}
												>
						...
						>
							...
							<CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
								{submissions.map((idea) => (
									<Card
										key={idea.id}
										className={`flex flex-col ${theme === "dark" ? "bg-gray-700 text-white" : ""
											}`}
									>
										<CardHeader>
								...
								<div className="flex items-start gap-4">
									...
									<div className="w-full space-y-2">
										...
										<div className="flex justify-between items-center">
											<Button
												className={`hover:bg-gray-300 cursor-pointer ${theme === "dark" ? "hover:bg-gray-600" : ""
													}`}
