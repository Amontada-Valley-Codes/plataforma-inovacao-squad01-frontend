    ...
    >
      ...
      <div className="p-4 w-full flex flex-col">
        ...
        <nav className="space-y-2 w-full">
          <Button
			variant="secondary"
			className={`w-full justify-start hovers-exit-dash ${isActive("/dashboard") ? "bg-[#001a90] active-exit-dash" : ""}`}
          ...
          <Button
            variant="ghost"
            className={`w-full justify-start hovers-exit-dash ${isActive("/startups") ? "bg-[#001a90] active-exit-dash" : ""}`}
