    ...
    <div id="Inicio" className="bg-white min-h-screen flex flex-col">
      ...
      <nav className="bg-[#011677] flex justify-between p-2 items-center w-full">
        ...
        <ul className="flex items-center mr-7 text-white space-x-10 text-[17px]">
          <li>
            <Link className="hovers-exit-dash rounded p-1" href="#Inicio">
              Inicio
            </Link>
          </li>
          <li>
            <Link className="hovers-exit-dash rounded p-1" href="#Desafios">
              Desafios
            </Link>
          </li>
          <li>
            <Link className="hovers-exit-dash rounded p-1" href="#Contato">
              Contato
            </Link>
          </li>
